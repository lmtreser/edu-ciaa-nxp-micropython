...
QDEF(MP_QSTR_packet_mode, (const byte*)"\xd1\x0b" "packet_mode")
QDEF(MP_QSTR_packet_end_char, (const byte*)"\x3a\x0f" "packet_end_char")
...
QDEF(MP_QSTR_get_baudrate, (const byte*)"\xfc\x0c" "get_baudrate")
...
QDEF(MP_QSTR_Keyboard, (const byte*)"\x48\x08" "Keyboard")
QDEF(MP_QSTR_get_matrix, (const byte*)"\x97\x0a" "get_matrix")
QDEF(MP_QSTR_get_char, (const byte*)"\x94\x08" "get_char")
QDEF(MP_QSTR_LCD, (const byte*)"\xce\x03" "LCD")
QDEF(MP_QSTR_goto_xy, (const byte*)"\xe8\x07" "goto_xy")
QDEF(MP_QSTR_config_cursor, (const byte*)"\x3a\x0d" "config_cursor")
QDEF(MP_QSTR_EEPROM, (const byte*)"\xc5\x06" "EEPROM")
QDEF(MP_QSTR_read_byte, (const byte*)"\x02\x09" "read_byte")
QDEF(MP_QSTR_write_byte, (const byte*)"\x8d\x0a" "write_byte")
QDEF(MP_QSTR_read_int, (const byte*)"\xfb\x08" "read_int")
QDEF(MP_QSTR_write_int, (const byte*)"\x94\x09" "write_int")
QDEF(MP_QSTR_read_float, (const byte*)"\x58\x0a" "read_float")
QDEF(MP_QSTR_write_float, (const byte*)"\x37\x0b" "write_float")
...
QDEF(MP_QSTR_read_bkp_reg, (const byte*)"\x7e\x0c" "read_bkp_reg")
QDEF(MP_QSTR_write_bkp_reg, (const byte*)"\xd1\x0d" "write_bkp_reg")
QDEF(MP_QSTR_calibration, (const byte*)"\xaf\x0b" "calibration")
QDEF(MP_QSTR_alarm_datetime, (const byte*)"\x68\x0e" "alarm_datetime")
QDEF(MP_QSTR_alarm_disable, (const byte*)"\x9d\x0d" "alarm_disable")
QDEF(MP_QSTR_MASK_SEC, (const byte*)"\x9b\x08" "MASK_SEC")
QDEF(MP_QSTR_MASK_MIN, (const byte*)"\x04\x08" "MASK_MIN")
QDEF(MP_QSTR_MASK_HR, (const byte*)"\xf4\x07" "MASK_HR")
QDEF(MP_QSTR_MASK_DAY, (const byte*)"\x92\x08" "MASK_DAY")
QDEF(MP_QSTR_MASK_MON, (const byte*)"\xc2\x08" "MASK_MON")
QDEF(MP_QSTR_MASK_YR, (const byte*)"\x85\x07" "MASK_YR")
QDEF(MP_QSTR_MASK_DOW, (const byte*)"\x52\x08" "MASK_DOW")
